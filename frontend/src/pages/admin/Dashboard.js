...
const Dashboard = () => {
    ...
    const pageDescription = 'Información general de la red de inclusión, estadísticas, gráficos, listados de habitantes y generación de (PDF, Excel, Imágenes) y visualización del mapa de la red de ';

    // Imprimir solo el mapa o mapa+listainclusión
