...
const refreshToken = async () => {
    if (isRefreshing) {
        console.log('Ya hay un refresco de token en curso, esperando...');
...
api.interceptors.request.use(
    async (config) => {
        ...
        console.log('Enviando solicitud a:', config.url, 'con headers:', {
            ...config.headers,
            'Authorization': 'Bearer [REDACTED]' // No mostrar el token real en los logs
        });
