...
def exportar_actividad(actividad_id, columnas=None):
    try:
        ...
        columnas_disponibles = [
            ...
            {'campo': 'tiene_certificado_discapacidad', 'etiqueta': '¿TIENE CERTIFICADO DE DISCAPACIDAD?', 'visible_por_defecto': True},
        ...
        def obtener_valor_campo(asistente, campo, indice, row_num=None):
            ...
            field_mapping = {
                ...
                'tiene_certificado_discapacidad': 'Sí' if beneficiario.get('tiene_certificado_discapacidad', False) else 'No',
